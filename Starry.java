...
public class Starry extends Activity implements CvCameraViewListener2 {
...
//    }
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if(finger != -1){
        	...
        	Intent intentStartGame = new Intent(Starry.this,SingleGameActivity.class);
            Bundle bundle = new Bundle();  
            bundle.putString("stageChosen",currentStage);
