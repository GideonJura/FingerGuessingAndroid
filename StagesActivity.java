...
public class StagesActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String stage = intentStartedFrom.getStringExtra("stage");
        if(!stage.equals("0")){
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_stage_go:
                ...
                Intent intentStartGame = new Intent(StagesActivity.this,SingleGameActivity.class);
                Intent intentStartedFrom = getIntent();
                String uname = intentStartedFrom.getStringExtra("Username");
//                String stage = intentStartedFrom.getStringExtra("stage");
                Bundle bundle = new Bundle();  
                bundle.putString("stageChosen",stagePointer);  
